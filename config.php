...
$serverName = "tcp:it21253126abcuni.database.windows.net,1433";
$conn = sqlsrv_connect($serverName, $connectionInfo);

// PDO Connection
try {
    $pdo = new PDO("sqlsrv:server = tcp:it21253126abcuni.database.windows.net,1433; Database = abcuni", "azuresql", "Alpha@0515");
